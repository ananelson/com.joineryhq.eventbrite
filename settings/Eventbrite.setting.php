...
return array(
  ...
  'eventbrite_autocreate_events' => array(
    'group_name' => 'Eventbrite Settings',
    'group' => 'eventbrite',
    'name' => 'eventbrite_autocreate_events',
    'add' => '',
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => E::ts('Automatically create a Civi event for all newly created or updated Eventbrite events.'),
    'title' => E::ts('Autocreate Events'),
    'type' => 'Boolean',
    'quick_form_type' => 'YesNo',
    'default' => 0,
    'html_type' => 'radio',
  ),
  // TODO select box of existing event types
  'eventbrite_default_event_type' => array(
    'group_name' => 'Eventbrite Settings',
    'group' => 'eventbrite',
    'name' => 'eventbrite_default_event_type',
    'add' => '',
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => E::ts('If Autocreate events is enabled, specify the default event type id for new events. (More sophisticated categorization is possible, see documentation.)'),
    'title' => E::ts('Default Event Type ID'),
    'type' => 'Integer',
    'quick_form_type' => 'Element',
    'default' => 0,
    'html_type' => 'Text',
